/**
   ...
   Contains main component of renju game. Similar to gomoku, but several moves for black stone
   are forbidden.Reads in command line arguments to determine if game should be saved to file,
   started up from existing file, or create a new game with custom grid size.
*/
...
int main(int argc, char **argv)
{
    ...
    // Otherwise create new game using either default or argument board size.
        ...
        activeGame = game_create( boardSize, GAME_RENJU );
